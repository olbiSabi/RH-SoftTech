...
urlpatterns = [
    ...
    path('sprints/<uuid:pk>/tickets/<uuid:ticket_pk>/add/', views.sprint_add_ticket, name='sprint_add_ticket'),
    path('sprints/<uuid:pk>/tickets/<uuid:ticket_pk>/remove/', views.sprint_remove_ticket, name='sprint_remove_ticket'),

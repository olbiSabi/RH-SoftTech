...
class ZYTEInline(admin.TabularInline):
    ...
    model = ZYTE
    extra = 1
    fields = ['numero', 'date_debut_validite', 'date_fin_validite']
...
class ZYMEInline(admin.TabularInline):
    ...
    model = ZYME
    extra = 1
    fields = ['email', 'date_debut_validite', 'date_fin_validite']
...
class ZYADInline(admin.TabularInline):
    ...
    model = ZYAD
    extra = 1
    fields = ['rue', 'ville', 'pays', 'code_postal', 'type_adresse', 'date_debut', 'date_fin']
...
class ZY00Admin(admin.ModelAdmin):
    ...
    list_display = [
        ...
        'sexe', 'type_dossier', 'date_validation_embauche'
    ]
...
class ZYTEAdmin(admin.ModelAdmin):
    ...
    list_display = ['employe', 'numero', 'date_debut_validite', 'date_fin_validite']
...
class ZYMEAdmin(admin.ModelAdmin):
    ...
    list_display = ['employe', 'email', 'date_debut_validite', 'date_fin_validite']
...
class ZYAFAdmin(admin.ModelAdmin):
    ...
    list_display = ['employe', 'poste', 'date_debut', 'date_fin']
...
class ZYADAdmin(admin.ModelAdmin):
    ...
    list_display = ['employe', 'ville', 'pays', 'type_adresse', 'date_debut', 'date_fin']
